...
messageParagraph.innerHTML = `We are a species friendly environment. ${species.name} are always welcome. We just ask that each patron is respectful of others and their choice of pet.`;
